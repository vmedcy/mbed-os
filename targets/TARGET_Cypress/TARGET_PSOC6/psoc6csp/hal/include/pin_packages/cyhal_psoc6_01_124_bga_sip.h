...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_spi_clk[14];
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_spi_miso[14];
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_spi_mosi[14];
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_spi_select0[14];
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_spi_select1[11];
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_spi_select2[11];
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_spi_select3[9];
